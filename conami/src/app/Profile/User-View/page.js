...
export default function ProfileView() {
  ...
  const handleFileChange = async (e) => {
    ...
    try {
      ...
      const res = await fetch("https://api.cloudinary.com/v1_1/dwaj95bl4/image/upload", {
        method: "POST",
        body: formData,
      });
      ...
      <div className="col-span-12 md:col-span-9 lg:col-span-10">
        <div className="bg-[#63372C] h-32 relative">
          ...
          <div className="absolute left-1/2 transform -translate-x-1/2 -bottom-14">
            ...
            <div
              className="absolute -bottom-1 right-6 bg-[#63372C] w-6 h-6 rounded-full flex items-center justify-center text-white shadow-lg cursor-pointer hover:scale-110 transform transition-transform z-10"
        ...
        <div className="text-center mt-16 space-y-1">
          ...
          <p className="text-sm">
            {UppercaseVar(user.gender)} • {user.age ?? "-"}
          </p>
        </div>
